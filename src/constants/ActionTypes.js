...
//Auth const
export const SIGNIN_IDENTITY_USER = 'signin_identity_user';
export const SIGNIN_IDENTITY_USER_SUCCESS = 'signin_identity_user_success';
...
export const SIGNUP_PROCESS_DONE = 'signup_process_done';
...
export const GET_USER_INFO = 'trypto-mc/IdSrv/GET_USER_INFO';
export const GET_USER_INFO_SUCCESS = 'trypto-mc/IdSrv/GET_USER_INFO_SUCCESS';

//Airports const

export const FETCH_ALL_AIRPORTS = 'fetch_all_airports';
export const FETCH_ALL_AIRPORTS_SUCCESS = 'fetch_all_airports_success';
...
export const FETCH_ALL_TENANTS_SUCCESS = 'fetch_all_tenants_success';
export const GET_TENANTS_BY_DOMAIN = 'get_tenants';
export const GET_TENANTS_BY_DOMAIN_SUCCESS = 'get_tenants_success';

export const GET_TIMEZONES = 'trypto-mc/CatalogApi/Geography/GET_TIMEZONES';
export const GET_TIMEZONES_SUCCESS = 'trypto-mc/CatalogApi/Geography/GET_TIMEZONES_SUCCESS';

export const GET_LOCALES = 'trypto-mc/CatalogApi/Geography/GET_LOCALES';
export const GET_LOCALES_SUCCESS = 'trypto-mc/CatalogApi/Geography/GET_LOCALES_SUCCESS';

export const GET_CURRENCIES = 'trypto-mc/CatalogApi/Currencies/GET_CURRENCIES';
export const GET_CURRENCIES_SUCCESS = 'trypto-mc/CatalogApi/Currencies/GET_CURRENCIES_SUCCESS';

export const GET_CURRENCY_BY_ID = 'trypto-mc/CatalogApi/Currencies/GET_CURRENCY_BY_ID';
export const GET_CURRENCY_BY_ID_SUCCESS = 'trypto-mc/CatalogApi/Currencies/GET_CURRENCY_BY_ID_SUCCESS';
export const GET_CURRENCY_BY_ID_CLEAR = 'trypto-mc/CatalogApi/Currencies/GET_CURRENCY_BY_ID_CLEAR';

export const FETCH_ALL_COUNTRIES = 'trypto-mc/CatalogApi/Geography/GET_COUNTRIES';
export const FETCH_ALL_COUNTRIES_SUCCESS = 'trypto-mc/CatalogApi/Geography/GET_COUNTRIES_SUCCESS';
export const FETCH_ALL_STATES_BY_COUNTRY = 'trypto-mc/CatalogApi/Geography/FETCH_ALL_STATES_BY_COUNTRY';
export const FETCH_ALL_STATES_BY_COUNTRY_SUCCESS = 'trypto-mc/CatalogApi/Geography/FETCH_ALL_STATES_BY_COUNTRY_SUCCESS';
export const RESET_STATE_ON_COUNTRY_NULL = 'trypto-mc/CatalogApi/Geography/RESET_STATE_ON_COUNTRY_NULL';
