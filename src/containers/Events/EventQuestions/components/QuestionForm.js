...
import { postEventQuestion } from '../actions';
...
class QuestionForm extends React.Component {
    ...
    componentWillMount = () => {
      ...
      this.props.fetchQuestionsList({tenantId, skip: 0, take: 1000, archived: false});
    }
    ...
    handleSubmit = event => {
      ...
      const {eventId, tenantsByDomain} = this.props;
      ...
      return (
        <FormDrawer open={this.props.showForm}>
          <FormDrawerHeader
            ...
            <IntlMessages id="containers.Events.EventQuestions.Form.heading" />
          </FormDrawerHeader>
          ...
          <FormDrawerContent>
            <FormControl className="w-100 mb-2">
              <FormLabel className={'shrink'}>
                ...
                <IntlMessages id="containers.Events.EventQuestions.Form.selectQuestion.label" />
              </FormLabel>
              <FormGroup>
                <Select
          ...
          <FormDrawerFooter>
            <Button
              ...
              variant="raised"
              color="primary">
              {actionLoader ? <CircularProgress size={24} color="secondary" /> : <IntlMessages id="containers.Events.EventQuestions.Form.btn.addQuestion" />}
            </Button>
...
const mapStateToProps = ({ eventQuestions, tenants, questions }) => {
  return {
